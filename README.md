...
2) Fill the [dwh.cfg](./dwh.cfg) file with your AWS details and also fill the ![dwh_airflow.cfg]('https://github.com/harisyammnv/DEND_Capstone_Airflow_EMR/blob/master/plugins/helpers/dwh_airflow.cfg')
